...
| Décomposition en facteurs premiers : existence et unicité | Spé | oui | `decomposition_en_facteurs_premiers_existence_et_unicite` | ☐ |
...
| Graphe probabiliste, matrice de transition ; convergence vers l'état stable (cas `2×2`) | Spé | oui | `graphe_probabiliste_matrice_de_transition_convergence_vers_l` | ☐ |
