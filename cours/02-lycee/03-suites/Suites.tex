% Fichier engendré par outils/generer-tex.py à partir de 03-suites.
...
$u_n = u_0 + nr$.
\end{definition}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L20}{Suites.lean\#L20}

\begin{definition}
La \emph{suite géométrique} de premier terme $u_0$ et de raison $q$ est
$u_n = u_0 q^n$.
\end{definition}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L23}{Suites.lean\#L23}

\begin{definition}
Deux suites sont \emph{adjacentes} lorsque l'une croît, l'autre décroît, et que leur
différence tend vers zéro.
\end{definition}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L27}{Suites.lean\#L27}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L33}{Suites.lean\#L33}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L37}{Suites.lean\#L37}
...
C'est la définition, écrite sous forme explicite.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L44}{Suites.lean\#L44}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L48}{Suites.lean\#L48}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L56}{Suites.lean\#L56}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L64}{Suites.lean\#L64}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L73}{Suites.lean\#L73}
...
$u_0 \ge 0$ conserve l'ordre.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L81}{Suites.lean\#L81}
...
\begin{proof}
La convergence au sens de Mathlib signifie que tout voisinage de $\ell$ contient les
termes à partir d'un certain rang ; dans un espace métrique, cela se réécrit avec les
boules, c'est-à-dire avec $\varepsilon$. Les deux formulations sont donc la même, ce que
la démonstration vérifie en dépliant la distance $|u_n - \ell|$.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L91}{Suites.lean\#L91}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L99}{Suites.lean\#L99}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L106}{Suites.lean\#L106}
...
triangulaire.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L113}{Suites.lean\#L113}
...
suite converge.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L118}{Suites.lean\#L118}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L124}{Suites.lean\#L124}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L131}{Suites.lean\#L131}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L142}{Suites.lean\#L142}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L147}{Suites.lean\#L147}
...
$1^n = 1$ pour tout $n$.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L152}{Suites.lean\#L152}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L160}{Suites.lean\#L160}
...
aussi.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L167}{Suites.lean\#L167}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L175}{Suites.lean\#L175}
...
$+\infty$.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L180}{Suites.lean\#L180}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L190}{Suites.lean\#L190}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L198}{Suites.lean\#L198}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/cours/02-lycee/03-suites/Suites.lean\#L223}{Suites.lean\#L223}
