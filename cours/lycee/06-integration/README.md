...
Fichier : `Integration.lean`

| Énoncé | Niveau | Admis | Théorème | Statut |
|---|---|---|---|---|
| Intégrale d'une fonction continue positive = aire sous la courbe | TS | oui | `integrale_d_une_fonction_continue_positive_aire_sous` | ☐ |
| Toute fonction continue sur un intervalle admet des primitives | TS | oui | `toute_fonction_continue_sur_un_intervalle_admet_des` | ☐ |
...
| Linéarité de l'intégrale | TS |  | `linearite_de_l_integrale` | ☐ |
...
| Aire entre deux courbes ; volume d'un solide de révolution (approche) | TS | oui | `aire_entre_deux_courbes_volume_d_un_solide` | ☐ |
