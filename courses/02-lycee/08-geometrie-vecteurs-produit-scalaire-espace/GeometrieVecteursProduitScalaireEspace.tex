% Fichier engendré par tools/generate-tex.py à partir de 08-geometrie-vecteurs-produit-scalaire-espace.
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L20}{GeometrieVecteursProduitScalaireEspace.lean\#L20}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L25}{GeometrieVecteursProduitScalaireEspace.lean\#L25}
...
puisque $y \ne 0$.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L36}{GeometrieVecteursProduitScalaireEspace.lean\#L36}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L61}{GeometrieVecteursProduitScalaireEspace.lean\#L61}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L84}{GeometrieVecteursProduitScalaireEspace.lean\#L84}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L105}{GeometrieVecteursProduitScalaireEspace.lean\#L105}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L122}{GeometrieVecteursProduitScalaireEspace.lean\#L122}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L146}{GeometrieVecteursProduitScalaireEspace.lean\#L146}
...
\begin{proof}
Il n'y a rien à démontrer ici, et c'est ce qu'il faut dire : ces trois propriétés sont les
\emph{axiomes} d'un espace préhilbertien réel, celles que la bibliothèque exige de toute
structure portant ce nom. Les citer, c'est constater que le produit scalaire du programme
est bien celui de la bibliothèque.

Une seule demande un mot. Mathlib définit le produit scalaire pour un corps de base
quelconque, et l'axiome y est la symétrie \emph{hermitienne}
$\langle u, v\rangle = \overline{\langle v, u\rangle}$. Sur $\mathbb{R}$, la conjugaison est
l'identité, et l'on retrouve la symétrie ordinaire — c'est la seule chose que la
démonstration formelle a à faire.

La linéarité à droite s'en déduirait par symétrie ; le programme ne demande que celle à
gauche.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L160}{GeometrieVecteursProduitScalaireEspace.lean\#L160}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L169}{GeometrieVecteursProduitScalaireEspace.lean\#L169}
...
\begin{proof}
L'argument est le développement de
...
\medskip\noindent
Mathlib l'énonce avec des produits $AC \times AC$ plutôt que des carrés, et avec la distance
$CB$ là où le programme écrit $BC$ : la symétrie de la distance permet de passer de l'une à
l'autre, et le reste est une mise en forme.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L177}{GeometrieVecteursProduitScalaireEspace.lean\#L177}

\begin{figure}[h]
\centering
\input{figures/produit_scalaire_definitions}
\caption{Le produit scalaire vu comme une projection : $\vec u \cdot \vec v$ vaut la longueur de $\vec u$ multipliée par celle du projeté de $\vec v$ sur la droite qui la porte, c'est-à-dire $\|\vec u\|\,\|\vec v\| \cos\theta$.}
\end{figure}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L186}{GeometrieVecteursProduitScalaireEspace.lean\#L186}
...
\begin{proof}
La loi des sinus s'obtient en calculant deux fois l'aire du triangle : $\tfrac12 AB \cdot AC
\sin \widehat{A}$ et $\tfrac12 BA \cdot BC \sin \widehat{B}$ mesurent la même chose. Sous la
forme du programme, en divisant par le produit des deux longueurs, cela s'écrit
\[ \frac{\sin \widehat{A}}{BC} = \frac{\sin \widehat{B}}{CA} , \]
le rapport commun étant l'inverse du diamètre du cercle circonscrit.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L199}{GeometrieVecteursProduitScalaireEspace.lean\#L199}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L207}{GeometrieVecteursProduitScalaireEspace.lean\#L207}

\begin{figure}[h]
\centering
\input{figures/al_kashi}
\caption{Le théorème d'Al-Kashi généralise Pythagore : le terme $-2bc\cos \hat A$ corrige l'égalité selon l'ouverture de l'angle, et s'annule quand celui-ci est droit.}
\end{figure}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L226}{GeometrieVecteursProduitScalaireEspace.lean\#L226}
...
vectorielle.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L241}{GeometrieVecteursProduitScalaireEspace.lean\#L241}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L271}{GeometrieVecteursProduitScalaireEspace.lean\#L271}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L279}{GeometrieVecteursProduitScalaireEspace.lean\#L279}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L291}{GeometrieVecteursProduitScalaireEspace.lean\#L291}
...
\begin{proof}
L'espace engendré par deux vecteurs est, par définition, l'ensemble des combinaisons
linéaires $s u + t v$ : la bibliothèque le démontre pour une partie à deux éléments, où
l'espace engendré se décrit ainsi explicitement.

Il ne reste qu'un détail d'écriture : la bibliothèque énonce l'égalité dans le sens
$su + tv = w$, l'énoncé dans le sens $w = su + tv$. Chaque implication se démontre en
reprenant le couple $(s, t)$ fourni par l'autre et en retournant l'égalité.

Dire que trois vecteurs sont coplanaires, c'est dire que l'un est dans l'espace engendré par
les deux autres — c'est-à-dire, exactement, qu'il s'écrit comme combinaison linéaire.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L306}{GeometrieVecteursProduitScalaireEspace.lean\#L306}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L317}{GeometrieVecteursProduitScalaireEspace.lean\#L317}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L346}{GeometrieVecteursProduitScalaireEspace.lean\#L346}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L357}{GeometrieVecteursProduitScalaireEspace.lean\#L357}
...
\begin{theoreme}
Deux plans distincts de l'espace ou bien ne se rencontrent pas, ou bien se coupent selon
une droite : leur intersection est vide ou de dimension $1$.
\end{theoreme}
\admis
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L391}{GeometrieVecteursProduitScalaireEspace.lean\#L391}

\begin{theoreme}
\emph{Théorème du toit.} Si deux plans sécants contiennent chacun l'une de deux droites
parallèles, leur droite d'intersection est parallèle à ces deux droites.
\end{theoreme}
\admis
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L401}{GeometrieVecteursProduitScalaireEspace.lean\#L401}

\begin{theoreme}
La distance d'un point $m$ au plan passant par $a$ et de vecteur normal $\vec{n}$ vaut
$\dfrac{|\langle \vec{n}, m - a \rangle|}{\|\vec{n}\|}$.
\end{theoreme}
\admis
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/08-geometrie-vecteurs-produit-scalaire-espace/GeometrieVecteursProduitScalaireEspace.lean\#L411}{GeometrieVecteursProduitScalaireEspace.lean\#L411}
