...
\begin{proof}
La première égalité est celle de la bibliothèque, obtenue du produit de Cauchy des séries.
En écrivant $\exp(a) = \sum_n a^n/n!$ et de même pour $b$, le produit des deux séries se
réordonne en
...
\begin{proof}
Les deux limites sont celles de la bibliothèque, et elles se déduisent de celles de
l'exponentielle par réciprocité.
...
\begin{proof}
Les six identités sont celles de la bibliothèque, et toutes se déduisent des formules
d'addition jointes aux valeurs remarquables.
...
\begin{proof}
Les quatre formules sont citées à la bibliothèque, qui les obtient des séries. Le chemin le
plus court passe par l'exponentielle complexe et l'identité $e^{i\theta} = \cos\theta +
