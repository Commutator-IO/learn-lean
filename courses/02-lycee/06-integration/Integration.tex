% Fichier engendré par tools/generate-tex.py à partir de 06-integration.
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L21}{Integration.lean\#L21}

\begin{figure}[h]
\centering
\input{figures/integrale_aire_sous_la_courbe}
\caption{L'intégrale d'une fonction continue positive est l'aire de la partie du plan comprise entre l'axe des abscisses et la courbe.}
\end{figure}
...
donc qu'un.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L34}{Integration.lean\#L34}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L39}{Integration.lean\#L39}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L55}{Integration.lean\#L55}
...
\begin{proof}
L'intégrale est linéaire parce qu'elle est construite comme une limite de sommes, et
qu'une somme l'est. L'additivité réclame que $f$ et $g$ soient intégrables sur l'intervalle, ce que leur continuité assure ; l'homogénéité ne demande
rien, la constante sortant de l'intégrale même lorsque celle-ci n'est pas définie.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L62}{Integration.lean\#L62}
...
\begin{proof}
La relation vaut dès que $f$ est intégrable sur les deux premiers intervalles, ce que la
continuité assure ici.
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L72}{Integration.lean\#L72}
...
\begin{proof}
La positivité vient de ce que l'intégrale d'une fonction positive est une limite de sommes de termes positifs ; la croissance s'en déduit
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L81}{Integration.lean\#L81}
...
de même aire.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L94}{Integration.lean\#L94}
...
\begin{proof}
Tout découle du théorème fondamental appliqué au produit $uv$ : la dérivée de $uv$ est $u'v + uv'$, donc
...
existe séparément.
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L119}{Integration.lean\#L119}
...
\end{proof}
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L131}{Integration.lean\#L131}
...
\begin{theoreme}
En tournant autour de l'axe des abscisses, la partie du plan située sous la courbe d'une
fonction continue positive $f$ engendre un solide de volume
$\pi \int_a^b f(x)^2 \, \mathrm{d}x$.
\end{theoreme}
\admis
\source{https://github.com/Commutator-IO/learn-lean/blob/main/courses/02-lycee/06-integration/Integration.lean\#L155}{Integration.lean\#L155}
