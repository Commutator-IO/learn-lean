...
\begin{figure}[h]
\centering
\input{figures/composition_symetries_centrales}
\caption{Deux demi-tours successifs. Le point revient à l'endroit, et le trajet total $\vec{MM_2}$ vaut le double de $\vec{O_1O_2}$ : la composée est une translation, quel que soit le point de départ.}
\end{figure}
...
\begin{figure}[h]
\centering
\input{figures/homothetie_multiplie_distances}
\caption{Une homothétie de centre $O$ et de rapport $1{,}8$. Les trois sommets s'éloignent de $O$ dans le même rapport, et toutes les distances de la figure sont multipliées par $1{,}8$.}
\end{figure}
