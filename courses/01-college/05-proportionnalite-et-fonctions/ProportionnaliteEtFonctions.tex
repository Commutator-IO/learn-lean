...
\begin{figure}[h]
\centering
\input{figures/coefficient_directeur}
\caption{Le coefficient directeur se lit sur deux points quelconques de la droite : c'est le rapport de l'accroissement vertical à l'accroissement horizontal, et il ne dépend pas du couple choisi.}
\end{figure}
