...
\begin{figure}[h]
\centering
\input{figures/encadrement}
\caption{Tout nombre est encadré par son plancher et l'entier suivant : il tombe dans l'un des intervalles $[n\,;n+1[$, et dans un seul.}
\end{figure}
